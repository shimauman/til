# Shimauman Til
Til means `today i learned`.<br />
What Shimauman learned through daily working and personal projects are on this web site.


[About Shimauman](https://shimauman.netlify.app)
...
- [localization-by-intl-plugin](./gatsby/localization-by-intl-plugin.md)
- [localization-switch-button](./gatsby/localization-switch-button.md)
...
- [1-1-difficult-program.md](./object-oriented-development/1-1-difficult-program.md)
- [1-2-purpose.md](./object-oriented-development/1-2-purpose.md)
- [2-1-sample-bad-code.md](./object-oriented-development/2-1-sample-bad-code.md)
- [2-2-not-use-short-name.md](./object-oriented-development/2-2-not-use-short-name.md)
- [2-3-use-blank-line.md](./object-oriented-development/2-3-use-blank-line.md)
- [2-4-assign-variables-to-each.md](./object-oriented-development/2-4-assign-variables-to-each.md)
- [2-5-extract-as-method.md](./object-oriented-development/2-5-extract-as-method.md)
- [2-6-extract-as-class](./object-oriented-development/2-6-extract-as-class.md)
- [2-7-not-use-magic-numbers](./object-oriented-development/2-7-not-use-magic-numbers.md)
- [2-8-make-value-object.md](./object-oriented-development/2-8-make-value-object.md)

## PHP
- [argument-type-declaration-practical-sample](./php/argument-type-declaration-practical-sample.md)
- [carbon-cheat-sheet](./php/carbon-cheat-sheet.md)
- [carbon-createFromFormat-trap](./php/carbon-createFromFormat-trap.md)
- [carbon-parse-vs-createFromFormat](./php/carbon-parse-vs-createFromFormat.md)
- [carbon-update-self-instance](./php/carbon-update-self-instance.md)
- [composer-command-cheat-sheet](./php/composer-command-cheat-sheet.md)
- [composer-events](./php/composer-events.md)
- [composer-install-options](./php/composer-install-options.md)
- [composer-root-package](./php/composer-root-package.md)
- [composer-solve-memory-limit](./php/composer-solve-memory-limit.md)
- [declare-strict-types-directive](./php/declare-strict-types-directive.md)
- [global-variable-definition](./php/global-variable-definition.md)
- [methods-cheat-sheet](./php/methods-cheat-sheet.md)
- [php-ini-location](./php/php-ini-location.md)
- [phpunit-assertSame-and-assertEquals-difference](./php/phpunit-assertSame-and-assertEquals-difference.md)
